...
import com.example.imtbf.presentation.adapters.ConfigFileAdapter;
...
import com.example.imtbf.utils.FileLogger;
...
public class MainActivity extends AppCompatActivity implements TrafficDistributionFragment.TrafficDistributionListener {
    ...
    private final BroadcastReceiver uiRefreshReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if ("com.example.imtbf.REFRESH_UI".equals(intent.getAction())) {
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (intent != null) {
            ...
            } else if ("com.example.imtbf.REFRESH_UI".equals(intent.getAction())) {
