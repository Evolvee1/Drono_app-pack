...
show_current_settings() {
  ...
  adb shell "am broadcast -a com.example.imtbf.debug.COMMAND -e command get_status -p $PACKAGE" > /dev/null
  ...
  echo "* Min Interval: $(get_pref_value com.example.imtbf.min_interval 5) seconds"
  echo "* Max Interval: $(get_pref_value com.example.imtbf.max_interval 15) seconds"
  echo "* Iterations: $(get_pref_value com.example.imtbf.iterations 100)"
  echo "* Airplane Mode Delay: $(get_pref_value com.example.imtbf.airplane_mode_delay 3000) ms"
  print_divider
